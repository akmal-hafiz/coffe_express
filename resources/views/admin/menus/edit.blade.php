...
<head>
  ...
  <title>Edit Menu - Coffee Express Admin</title>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-xl font-extrabold">Edit Menu</h1>
            <p class="text-xs text-white/80">Update informasi menu</p>
          </div>
        </div>
      ...
      <form action="{{ route('admin.menus.update', $menu) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="number" id="price" name="price" value="{{ old('price', $menu->price) }}" required min="0" step="0.01"
        ...
        @if($menu->image)
          <div class="mb-6">
            ...
            <img src="{{ asset('storage/' . $menu->image) }}" alt="{{ $menu->name }}" class="w-full max-w-xs rounded-lg shadow-md">
          </div>
        @endif
        ...
        <div class="mb-6">
          <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">
            {{ $menu->image ? 'Ganti Gambar' : 'Upload Gambar' }}
          </label>
